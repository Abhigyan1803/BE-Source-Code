...
public class AddBnCdrMarksPayLoad {

   private int moral=0;
	
	private int dynamic=0;
	
	private int influencing=0;
	...
	private Long termSeasonId=0l;

	private String serviceId="";
	
	private Long bnCdrId=0l;
	...
	public Long getBnCdrId() {
		return bnCdrId;
	}

	public void setBnCdrId(Long bnCdrId) {
		this.bnCdrId = bnCdrId;
	}
