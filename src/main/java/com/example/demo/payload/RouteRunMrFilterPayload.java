...
public class RouteRunMrFilterPayload {
	...
	private RunbackRouteMr runbackRouteMrResult;
	...
	public RunbackRouteMr getRunbackRouteMrResult() {
		return runbackRouteMrResult;
	}

	public void setRunbackRouteMrResult(RunbackRouteMr runbackRouteMrResult) {
		this.runbackRouteMrResult = runbackRouteMrResult;
	}
