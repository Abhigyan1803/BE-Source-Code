...
public class OqMarksFilterPayload {
	...
	private OqMarksResult oqMarksResult;
	public Long getId() {
		return id;
	}
	...
	public OqMarksResult getOqMarksResult() {
		return oqMarksResult;
	}
	public void setOqMarksResult(OqMarksResult oqMarksResult) {
		this.oqMarksResult = oqMarksResult;
	}
