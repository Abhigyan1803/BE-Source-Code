...
public class CreditExcellenceFilterPayload {
	...
	private AcademicCreditForExcellenceResult academicCreditForExcellenceResult;
	...
	public AcademicCreditForExcellenceResult getAcademicCreditForExcellenceResult() {
		return academicCreditForExcellenceResult;
	}

	public void setAcademicCreditForExcellenceResult(
			AcademicCreditForExcellenceResult academicCreditForExcellenceResult) {
		this.academicCreditForExcellenceResult = academicCreditForExcellenceResult;
	}
}
