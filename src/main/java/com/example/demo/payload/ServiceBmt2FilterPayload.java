...
public class ServiceBmt2FilterPayload {
	...
	private ServiceBmt2Result serviceBmt2Result;
	public Long getId() {
		return id;
	}
	...
	public ServiceBmt2Result getServiceBmt2Result() {
		return serviceBmt2Result;
	}
	public void setServiceBmt2Result(ServiceBmt2Result serviceBmt2Result) {
		this.serviceBmt2Result = serviceBmt2Result;
	}
