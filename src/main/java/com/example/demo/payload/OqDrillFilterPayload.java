...
public class OqDrillFilterPayload {
	...
	private OqDrillResult oqDrillResult;
	public Long getId() {
		return id;
	}
	...
	public OqDrillResult getOqDrillResult() {
		return oqDrillResult;
	}
	public void setOqDrillResult(OqDrillResult oqDrillResult) {
		this.oqDrillResult = oqDrillResult;
	}
