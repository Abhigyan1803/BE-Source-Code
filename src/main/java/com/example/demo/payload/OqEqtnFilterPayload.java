...
public class OqEqtnFilterPayload {
	private Long id;
	...
	private OqEqtnResult oqEqtnResult;
	public Long getId() {
		return id;
	}
	...
	public OqEqtnResult getOqEqtnResult() {
		return oqEqtnResult;
	}
	public void setOqEqtnResult(OqEqtnResult oqEqtnResult) {
		this.oqEqtnResult = oqEqtnResult;
	}
