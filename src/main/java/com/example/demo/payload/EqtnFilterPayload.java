...
public class EqtnFilterPayload {
	private Long id;
	...
	public TRG_EQTNResult getTrgEQTNResult() {
		return trgEQTNResult;
	}

	public void setTrgEQTNResult(TRG_EQTNResult trgEQTNResult) {
		this.trgEQTNResult = trgEQTNResult;
	}

	private String nationality;

	private TRG_EQTNResult trgEQTNResult;
