...
public class EdossierPtResultFilterPayload {
	private Long id;
	...
	private EdossierPtResult edossierPtResult;
	public Long getId() {
		return id;
	}
	...
	public EdossierPtResult getEdossierPtResult() {
		return edossierPtResult;
	}
	public void setEdossierPtResult(EdossierPtResult edossierPtResult) {
		this.edossierPtResult = edossierPtResult;
	}
